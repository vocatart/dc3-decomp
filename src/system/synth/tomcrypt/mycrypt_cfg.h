 ...
 *
 * With this you can setup what to inlcude/exclude automatically during any build.  Just
 * comment out the line that #define's the word for the thing you want to remove.  phew!
 */
...
/* Controls endianess and size of registers.  Leave uncommented to get platform neutral
 * [slower] code */
