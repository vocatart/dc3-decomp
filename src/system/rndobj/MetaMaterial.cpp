...
BEGIN_PROPSYNCS(MetaMaterial)
    ...
    SYNC_MAT_PROP(tex_wrap, (int &)mTexWrap, 6)
    SYNC_MAT_PROP(tex_gen, (int &)mTexGen, 7)
    SYNC_MAT_PROP(tex_xfm, mTexXfm, 8)
    SYNC_MAT_PROP(blend, (int &)mBlend, 9)
    SYNC_MAT_PROP(z_mode, (int &)mZMode, 10)
    ...
    SYNC_MAT_PROP(shader_variation, (int &)mShaderVariation, 43)
    ...
    SYNC_MAT_PROP(cull, (int &)mCull, 48)
    SYNC_MAT_PROP(stencil_mode, (int &)mStencilMode, 49)
